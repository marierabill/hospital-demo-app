...
public function index() {
    $data['total_patients'] = $this->db->count_all('patients');
    $data['total_appointments'] = $this->db->count_all('appointments');
    $data['appointments_per_doctor'] = $this->Report_model->get_appointments_per_doctor();
